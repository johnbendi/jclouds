...
and compute, from Java and Clojure.  Our API gives/allows developers the opportunity to use
...
* SIMPLE INTERFACE
Instead of creating new object types, we reuse concepts like maps so that the programming model is familiar. In this way, you can get started without dealing with REST-like apis or WS of the cloud providers.
